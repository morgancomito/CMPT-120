...
# don't let this intimidate you. break it down a part at a time. You've done all of these separately, and now we're just
# combining them.
"""
Instructions: Create a list with at least 8 numbers, and make sure you have a random dispersement between 0-50
Create a loop (which loop would be best given we know how long we're going [the length of the list]?) that runs
