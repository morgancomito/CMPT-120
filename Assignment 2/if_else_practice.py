...
# The first if statement should read: if 10 (but use our variable, not the number 10) is greater than 12, print out
...
def main():
    ...
    ten = 10
    if ten > 12:
        print(ten, "is greater than 12")
    elif ten > 11:
        print(ten, "is greater than 11")
    elif ten == 10:
        print(ten, "is equal to 10")
    else:
        print(ten, "is less than 10")
